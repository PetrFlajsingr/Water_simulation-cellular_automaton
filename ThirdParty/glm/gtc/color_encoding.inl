...
namespace glm {
template <typename T, precision P> GLM_FUNC_QUALIFIER tvec3<T, P> convertLinearSRGBToD65XYZ(tvec3<T, P> const &ColorLinearSRGB) {
...
template <typename T, precision P> GLM_FUNC_QUALIFIER tvec3<T, P> convertD65XYZToLinearSRGB(tvec3<T, P> const &ColorD65XYZ) {
...
template <typename T, precision P> GLM_FUNC_QUALIFIER tvec3<T, P> convertLinearSRGBToD50XYZ(tvec3<T, P> const &ColorLinearSRGB) {
...
template <typename T, precision P> GLM_FUNC_QUALIFIER tvec3<T, P> convertD50XYZToLinearSRGB(tvec3<T, P> const &ColorD50XYZ) {
  tvec3<T, P> const M();
  tvec3<T, P> const N();
  tvec3<T, P> const O();
...
template <typename T, precision P> GLM_FUNC_QUALIFIER tvec3<T, P> convertD65XYZToD50XYZ(tvec3<T, P> const &ColorD65XYZ) {
...
template <typename T, precision P> GLM_FUNC_QUALIFIER tvec3<T, P> convertD50XYZToD65XYZ(tvec3<T, P> const &ColorD50XYZ) {
  tvec3<T, P> const M();
  tvec3<T, P> const N();
  tvec3<T, P> const O();
