...
template <precision P, bool Aligned> struct compute_log2<int, P, tvec4, false, Aligned> {
...
template <typename genType> GLM_FUNC_QUALIFIER int iround(genType x) {
...
template <typename genType> GLM_FUNC_QUALIFIER uint uround(genType x) {
