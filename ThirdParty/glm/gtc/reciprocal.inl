...
namespace glm {
// sec
template <typename genType> GLM_FUNC_QUALIFIER genType sec(genType angle) {
...
// csc
template <typename genType> GLM_FUNC_QUALIFIER genType csc(genType angle) {
...
// cot
template <typename genType> GLM_FUNC_QUALIFIER genType cot(genType angle) {
...
// asec
template <typename genType> GLM_FUNC_QUALIFIER genType asec(genType x) {
...
// acsc
template <typename genType> GLM_FUNC_QUALIFIER genType acsc(genType x) {
...
// acot
template <typename genType> GLM_FUNC_QUALIFIER genType acot(genType x) {
...
// sech
template <typename genType> GLM_FUNC_QUALIFIER genType sech(genType angle) {
...
// csch
template <typename genType> GLM_FUNC_QUALIFIER genType csch(genType angle) {
...
// coth
template <typename genType> GLM_FUNC_QUALIFIER genType coth(genType angle) {
...
// asech
template <typename genType> GLM_FUNC_QUALIFIER genType asech(genType x) {
...
// acsch
template <typename genType> GLM_FUNC_QUALIFIER genType acsch(genType x) {
...
// acoth
template <typename genType> GLM_FUNC_QUALIFIER genType acoth(genType x) {
