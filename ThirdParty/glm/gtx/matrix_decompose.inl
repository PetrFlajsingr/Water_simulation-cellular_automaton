...
template <typename T, precision P> GLM_FUNC_QUALIFIER tvec3<T, P> scale(tvec3<T, P> const &v, T desiredLength) {
...
template <typename T, precision P> GLM_FUNC_QUALIFIER bool decompose(tmat4x4<T, P> const &ModelMatrix, tvec3<T, P> &Scale,
                                                                     tquat<T, P> &Orientation, tvec3<T, P> &Translation,
                                                                     tvec3<T, P> &Skew, tvec4<T, P> &Perspective) {
  ...
  if (LocalMatrix[0][3] != static_cast<T>(0) || LocalMatrix[1][3] != static_cast<T>(0) ||
    ...
    tmat4x4<T, P> InversePerspectiveMatrix =
