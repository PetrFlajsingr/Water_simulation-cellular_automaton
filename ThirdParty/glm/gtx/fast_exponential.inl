...
namespace glm {
// fastPow:
template <typename genType> GLM_FUNC_QUALIFIER genType fastPow(genType x, genType y) { return exp(y * log(x)); }
...
template <typename T> GLM_FUNC_QUALIFIER T fastPow(T x, int y) {
  T f = static_cast<T>(1);
  for (int i = 0; i < y; ++i)
    f *= x;
  return f;
...
template <typename T> GLM_FUNC_QUALIFIER T fastExp(T x) {
...
GLM_FUNC_QUALIFIER float fastExp(float x)
{
    ...
    float x7 = x6 * x;
    float x8 = x7 * x;
    return 1.0f + x + (x2 * 0.5f) + (x3 * 0.1666666667f) + (x4 * 0.041666667f) + (x5 * 0.008333333333f)+ (x6 * 0.00138888888888f)
+ (x7 * 0.000198412698f) + (x8 * 0.0000248015873f);;
}
*/
...
// fastLog
template <typename genType> GLM_FUNC_QUALIFIER genType fastLog(genType x) { return std::log(x); }
...
template <typename genType> GLM_FUNC_QUALIFIER genType fastExp2(genType x) {
...
template <typename genType> GLM_FUNC_QUALIFIER genType fastLog2(genType x) {
