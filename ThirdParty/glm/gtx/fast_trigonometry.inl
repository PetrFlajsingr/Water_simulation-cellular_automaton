...
GLM_FUNC_QUALIFIER vecType<T, P> taylorCos(vecType<T, P> const &x) {
  return static_cast<T>(1) - (x * x) / 2.f + (x * x * x * x) / 24.f - (x * x * x * x * x * x) / 720.f +
         (x * x * x * x * x * x * x * x) / 40320.f;
}

template <typename T> GLM_FUNC_QUALIFIER T cos_52s(T x) {
  T const xx(x * x);
...
// wrapAngle
template <typename T> GLM_FUNC_QUALIFIER T wrapAngle(T angle) { return abs<T>(mod<T>(angle, two_pi<T>())); }
...
// cos
template <typename T> GLM_FUNC_QUALIFIER T fastCos(T x) {
...
// sin
template <typename T> GLM_FUNC_QUALIFIER T fastSin(T x) { return fastCos<T>(half_pi<T>() - x); }
...
// tan
template <typename T> GLM_FUNC_QUALIFIER T fastTan(T x) {
...
// asin
template <typename T> GLM_FUNC_QUALIFIER T fastAsin(T x) {
  return x + (x * x * x * T(0.166666667)) + (x * x * x * x * x * T(0.075)) + (x * x * x * x * x * x * x * T(0.0446428571)) +
         (x * x * x * x * x * x * x * x * x * T(0.0303819444)); // + (x * x * x * x * x * x * x * x * x * x * x * T(0.022372159));
}
...
// acos
template <typename T> GLM_FUNC_QUALIFIER T fastAcos(T x) {
...
// atan
template <typename T> GLM_FUNC_QUALIFIER T fastAtan(T y, T x) {
  T sgn = sign(y) * sign(x);
...
template <typename T> GLM_FUNC_QUALIFIER T fastAtan(T x) {
  return x - (x * x * x * T(0.333333333333)) + (x * x * x * x * x * T(0.2)) - (x * x * x * x * x * x * x * T(0.1428571429)) +
         (x * x * x * x * x * x * x * x * x * T(0.111111111111)) - (x * x * x * x * x * x * x * x * x * x * x * T(0.0909090909));
}
