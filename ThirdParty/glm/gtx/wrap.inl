...
template <typename genType> GLM_FUNC_QUALIFIER genType clamp(genType const &Texcoord) {
...
template <typename genType> GLM_FUNC_QUALIFIER genType repeat(genType const &Texcoord) {
...
template <typename genType> GLM_FUNC_QUALIFIER genType mirrorClamp(genType const &Texcoord) {
...
template <typename genType> GLM_FUNC_QUALIFIER genType mirrorRepeat(genType const &Texcoord) {
