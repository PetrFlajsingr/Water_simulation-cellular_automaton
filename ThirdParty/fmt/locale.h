...
namespace internal {
template <typename Char> typename buffer_context<Char>::iterator vformat_to(const std::locale &loc, buffer<Char> &buf,
...
template <typename Char> std::basic_string<Char> vformat(const std::locale &loc, basic_string_view<Char> format_str,
                                                         basic_format_args<buffer_context<Char>> args) {
...
vformat(const std::locale &loc, const S &format_str, basic_format_args<buffer_context<Char>> args) {
