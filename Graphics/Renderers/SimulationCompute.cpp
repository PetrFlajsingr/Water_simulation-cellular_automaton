...
SimulationCompute::SimulationCompute(const glm::uvec3 tankSize, const std::shared_ptr<Buffer> &ibo,
                                     const std::shared_ptr<Buffer> &positionBuffer) : tankSize(tankSize), ibo(ibo),
