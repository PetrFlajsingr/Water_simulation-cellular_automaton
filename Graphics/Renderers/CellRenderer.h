...
public:
  ...
  void draw(const glm::mat4 &viewMat, const glm::vec3 &cameraPos, const BufferPtr& cellBuffer, const BufferPtr& cellInfoBuffer, bool visualizeVolumes, float cellSize = 0.5);
