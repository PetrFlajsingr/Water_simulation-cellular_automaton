...
std::vector<glm::vec3> GridRenderer::generateBox(glm::ivec3 length) { return generateBox(length.x, length.y, length.z); }

GridRenderer::GridRenderer(glm::vec3 gridSize, glm::mat4 projectionMat) : projectionMat(projectionMat) {
